...
public class SuperWeChatHelper {
    ...
    private User setCurrentUser = null;

    public User getSetCurrentUser() {
        return setCurrentUser;
    }

    public void setSetCurrentUser(User setCurrentUser) {
        ...
        public void onContactAdded(String username) {
           ...
           Map<String,User> localAppUser =  getAppContactList();
            if (!localAppUser.containsKey(username)){
                NetDao.addFriend(appContext,EMClient.getInstance().getCurrentUser(), username, new OkHttpUtils.OnCompleteListener<String>() {
                    @Override
